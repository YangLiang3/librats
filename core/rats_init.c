...
char rats_verifier_name[RATS_VERIFIER_NUM][RATS_NAME] = {"nullverifier", "sgx_ecdsa", "sgx_ecdsa_qve", "sgx_la"};
#endif

rats_attester_err_t rats_collect_init(rats_conf_t *conf, rats_core_context_t *ctx)
{
